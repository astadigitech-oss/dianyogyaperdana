<div>
    <div class="relative group group-hover:cursor-pointer">
        <button
            class="flex transition-all duration-500 border-b-[4px] border-[#01093F] px-5 group-hover:border-[#FF2500] gap-[20px] h-[70px] text-white items-center">
            <div class="flex items-center gap-[10px]">
                <div class="w-[16px] h-[16px]">
                    {{$svg}}
                </div>
                <p class="inter text-[16px]">{{$label}}</p>
            </div>
            <div class="">
                <svg class="group-hover:rotate-180 transition-all duration-300" width="24" height="24"
        ...
        <div
            class="absolute w-full max-h-0 overflow-hidden bg-white px-2 transition-all duration-500 group-hover:max-h-[900px]">
            {{$slot}}
        </div>
